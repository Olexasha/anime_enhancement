...
- `assets/branding/icon.png` — исходник для portable/setup ярлыков.
- `assets/branding/banner_1200x380.png`

Windows assets:

- `packaging/windows/assets/anime_enhancement.ico` — Windows `.ico` для приложения, setup и ярлыков.
...
- Иконка desktop-ярлыка берется из общего `assets/branding/icon.png`.
