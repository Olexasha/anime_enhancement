...
def configure_test_environment(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setenv("INTERMEDIATE_VIDEO_ENCODER", "libx264")
    monkeypatch.setenv("INTERMEDIATE_VIDEO_CRF", "12")
    monkeypatch.setenv("INTERMEDIATE_VIDEO_PRESET", "medium")
    monkeypatch.setenv("INTERMEDIATE_VIDEO_PIX_FMT", "yuv444p")
    monkeypatch.setenv("INTERMEDIATE_VIDEO_CONTAINER", "mkv")
