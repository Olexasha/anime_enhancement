...
VIDEO_TUNE = _CONFIG.VIDEO_TUNE
VIDEO_NVENC_CQ = _CONFIG.VIDEO_NVENC_CQ
VIDEO_PIX_FMT = _CONFIG.VIDEO_PIX_FMT
INTERMEDIATE_VIDEO_ENCODER = _CONFIG.INTERMEDIATE_VIDEO_ENCODER.lower()
INTERMEDIATE_VIDEO_CRF = _CONFIG.INTERMEDIATE_VIDEO_CRF
INTERMEDIATE_VIDEO_PRESET = _CONFIG.INTERMEDIATE_VIDEO_PRESET
INTERMEDIATE_VIDEO_PIX_FMT = _CONFIG.INTERMEDIATE_VIDEO_PIX_FMT
INTERMEDIATE_VIDEO_CONTAINER = _CONFIG.INTERMEDIATE_VIDEO_CONTAINER.lower()
